#
#  Be sure to run `pod spec lint BSNumbers.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.2.1"
  s.summary      = "A view that display form just like numbers(os x) or excel(windows)"
  ...
  s.source       = { :git => "https://github.com/blurryssky/BSNumbersView.git", :tag => "0.2.1" }
